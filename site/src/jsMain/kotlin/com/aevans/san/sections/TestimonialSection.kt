...
import com.aevans.san.components.TestimonialCard
...
)
{
    ...
    {
        Box {
            testimonial1.forEach {
                testimonial ->
                TestimonialCard(
                    modifier = Modifier
                        .margin(
                            right = if (breakpoint > Breakpoint.SM)
                                40.px
                            else
                                0.px,
                        ...
                        .transition(
                            CSSTransition(
                                property = "visibility", duration = 300.ms
                            ),
                            CSSTransition(
